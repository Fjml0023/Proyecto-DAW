...
@ViewScoped
@Named( value="biblio")
public class BiblioLoginController implements Serializable {
    private static final Logger logger = Logger.getLogger(BiblioLoginController.class.getName());
    ...
    public String login() {
        ...
        if (sc.authenticate(request, response, ap) == AuthenticationStatus.SUCCESS) {
            view="/salas/index?faces-redirect=true";
